(function() {
  ...
  popup.style.maxHeight = '600px';
        ...
        openBtn.title = 'Search with Dhamma.Gift';
        ...
        dictBtn.style.right = '90px'; // Positioned to the left of openBtn
        dictBtn.style.border = 'none';
        dictBtn.style.background = '#2D3E50'; // Different color for distinction
        dictBtn.style.color = 'white';
        ...
        dictBtn.target = '_blank'; // Open link in a new tab
        dictBtn.title = 'Open in DPD full mode';
...
<svg
   ...
   xmlns:svg="http://www.w3.org/2000/svg"><sodipodi:namedview
    ...
    document.addEventListener('touchend', stopResize);
        ...
        return { overlay, popup, iframe, openBtn, dictBtn };

    }

    const { overlay, popup, iframe, openBtn, dictBtn } = createPopup();
